...
SECRET_KEY = 'pl!6a7f5fyl^%3-17-f41=t5$$^*-dh1g6vycre=@k6z3n@%u='
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR,'myapps/templates/myapps'),
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'myapps/static')]
